...
<head>
  ...
  <title>COVID-19-vaccine-lists</title>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-md-12 d-flex align-items-stretch mt-5" id="abc">
            <div class="card w-100">
              <div class="card-body p-4">
                <h5 class="card-title fw-semibold mb-4">Vaccine lists </h5>
                  ...
                  <table class="table text-nowrap mb-0 align-middle table-bordered table-striped">
                    <thead class="text-dark fs-4">
                      <tr>
                        ...
                        <th class="border-bottom-0">
                          <h6 class="fw-semibold mb-0">Expiry_date</h6>
                        </th>
                        <th class="border-bottom-0">
                          <h6 class="fw-semibold mb-0">AvailableOrNot</h6>
                        </th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        @foreach ($vaccine as $items )
                        <tr>  
                          <td class="border-bottom-0">
                            <h6 class="fw-semibold mb-0">{{$loop->iteration}}</h6>
                          </td>
                          <td class="border-bottom-0">
                            <p class="fw-semibold mb-0 fs-4">{{$items->Vaccine_name}}</p>
                          </td>
                          <td class="border-bottom-0">
                            <p class="fw-semibold mb-0 fs-4">{{$items->Manufacture}}</p>
                          </td>
                          <td class="border-bottom-0">
                            <p class="fw-semibold mb-0 fs-4">{{$items->Expiry_date}}</p>
                          </td>
                          <td class="border-bottom-0">
                            <p class="fw-semibold mb-0 fs-4">{{$items->AvailableOrNot}}</p>
                          </td>
                          @endforeach
                        </tr>                    
                      </tbody>
