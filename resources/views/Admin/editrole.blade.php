...
input[type="checkbox"] {
    margin-right: 10px; /* Adjust the right margin to control horizontal spacing */
    margin-bottom: 10px; /* Adjust the bottom margin to control vertical spacing */
}

.label {
    margin-right: 20px; /* Adjust the spacing between labels and checkboxes */
}
          ...
          <ul id="sidebarnav">
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{route('role.main')}}">
                ...
                <span class="hide-menu">Assign Roles</span>
              </a>
            </li>
          </ul>
        </nav>
                        ...
                        @foreach ($permission  as $perm)
                            <div class="mb-3">
                                <input type="checkbox" id="{{ $perm->id }}" name="roles[]"
                                    value="{{ $perm->name }}"
                                    {{ $data->contains($perm->name) ? 'checked' : '' }} />
