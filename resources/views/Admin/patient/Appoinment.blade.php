...
<head>
  ...
  <title>COVID-19-create-appoinment</title>
              ...
              <div class="col-lg-8 ">
                <div class="card rounded-3">
                  ...
                  <div class="card-body p-4 p-md-5">
                    <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 px-md-2" style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">Create Appoinment</h3>
        
                    <form class="px-md-2" action="{{route('patient.appoinmentget')}}" method="POST">
                     @csrf
                     <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-12 mb-4">
                        <div class="mb-3">
                            ...
                            <select name="patient" id="patient" class="form-control @error('patient') is-invalid @enderror">
                                <option value="" disabled selected>Choose...</option>
                                @foreach ($booking as $data)
                                    <option value="{{ $data->id }}" {{ old('patient') == $data->id ? 'selected' : '' }}>
                                        {{ $data->name }}
                                    </option>
                                @endforeach
                            </select>
                      ...
                      <div class="row">
                        <div class="col-md-12 mb-4">
                          <div class="mb-3">
                            <label for="exampleInputdate" class="form-label">Appoinment_date</label>
                      ...
                      <div class="row">
                        <div class="col-md-12 mb-4">
                          <div class="mb-3">
                              <label for="exampleInputtime" class="form-label">Appoinment_timing</label>
                      ...
                      <button type="submit" data-mdb-button-init data-mdb-ripple-init class="btn">Submit</button>
                        </div>
                    </div>
                    </form>
        </section>
