...
<head>
  ...
  <title>COVID-19-Appoinment</title>
          ...
          <div class="col-lg-8 d-flex align-items-stretch" id="abc">
            <div class="card w-100">
              <div class="card-body p-4">
                <h5 class="card-title fw-semibold mb-4">Appoinment lists</h5>
                    ...
                    <thead class="text-dark fs-4">
                      <tr>
                        ...
                        <th class="border-bottom-0">
                          ...
                          <th class="border-bottom-0">
                            <h6 class="fw-semibold mb-0">Appoinment_date</h6>
                          </th>
                          <th class="border-bottom-0">
                            <h6 class="fw-semibold mb-0">Appoinment_timing</h6>
                          </th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        @foreach ($appoiment as $items )
                        <tr>  
                          ...
                          <td class="border-bottom-0">
                            <p class="fw-semibold mb-0 fs-4">{{$items->Appoiment_date}}</p>
                          </td>
                          <td class="border-bottom-0">
                            <p class="fw-semibold mb-0 fs-4">{{$items->Appoiment_time}}</p>
                          </td> 
                            @endforeach
                          </tr>                    
                    </tbody>
