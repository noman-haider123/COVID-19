...
<head>
  ...
  <title>COVID-19-vaccination-status</title>
          ...
          <div class="col-lg-8 d-flex align-items-stretch mt-5" id="abc">
            <div class="card w-100">
              <div class="card-body p-4">
                <h5 class="card-title fw-semibold mb-4">Vaccination_status</h5>
                    ...
                    <thead class="text-dark fs-4">
                      <tr>
                        ...
                        <th class="border-bottom-0">
                          ...
                          <th class="border-bottom-0">
                            <h6 class="fw-semibold mb-0">Not Vaccinated</h6>
                          </th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        ...
                        <tr>  
                          ...
                          <td class="border-bottom-0">
                            <p class="fw-semibold mb-0 fs-4">{{$items->Vaccination_status}}</p>
                          </td>
                          <td class="border-bottom-0">
                            @if ($items->Vaccination_status != "Vaccinated")
                            <a href="{{route('patient.vaccinated',$items->id)}}" class="btn">Vaccinated</a>
                            @endif
                          </td>
                          <td class="border-bottom-0">
                            @if ($items->Vaccination_status != "Not Vaccinated")
                            <a href="{{route('patient.unvaccinated',$items->id)}}" class="btn">Not Vaccinated</a>
                            @endif
                          </td>
                        </tr>                    
                        @endforeach
