...
<head>
    ...
    <title>COVID-19-Hospital-name</title>
                                        ...
                                        <table class="table text-nowrap mb-0 align-middle table-bordered table-striped">
                                            <thead class="text-dark fs-4">
                                                <tr>
                                                    ...
                                                    <th class="border-bottom-0">
                                                        <h6 class="fw-semibold mb-0">View_Report</h6>
                                                    </th>
                                                </tr>
                                                @foreach ($report as $items)
                                                <tr>
                                                  <td class="border-bottom-0">
                                                    <h4 class="fw-semibold mb-0">{{ $items->user->name }}</h4>
                                                  </td>
                                                  <td class="border-bottom-0">
                                                    <h4 class="fw-semibold mb-0">{{ $items->booking->name }}</h4>
                                                  </td>
                                                  <td class="border-bottom-0">
                                                    <h4 class="fw-semibold mb-0">{{ $items->booking->address}}</h4>
                                                  </td>
                                                  <td class="border-bottom-0">
                                                    <a href="{{ route('patient.easily', $items->id) }}" class="btn">View and Take Report</a>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                    </div>
