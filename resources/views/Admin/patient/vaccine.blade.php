          ...
          <div class="col-lg-8 d-flex align-items-stretch" id="abc">
            <div class="card w-100 mt-4">
              <div class="card-body p-4">
                <h5 class="card-title fw-semibold mb-4">Vaccine Request Details</h5>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <tr>  
                            ...
                            <td class="border-bottom-0">
                                <p class="fw-semibold mb-0 fs-4">{{$items->data->name}}</p>
                            </td>
                            <td class="border-bottom-0">
                            ...
                            <td class="border-bottom-0">
                              ...
                              <a href="{{route('patient.fetch',$items->id)}}" class="btn">Approve</a>
                              @endif
                            </td>
                            <td class="border-bottom-0">
                              @if ($items->Status != "Approved")
                                <a href="{{route('patient.reject',$items->id)}}" onclick="return confirmDelete(event, this);" class="btn">Reject</a>
                              @endif
                              </td>
                        </tr>
                        @endforeach
                ...
                <script>
                  function confirmDelete(event, element) {
                      ...
                      if (confirm('Are you sure you want to delete this Vaccine Request?')) {
