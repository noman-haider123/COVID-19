...
<head>
  ...
  <title>Covid-19-booking-lists</title>
          ...
          <div class="col-lg-8 d-flex align-items-stretch" id="abc">
            <div class="card w-100 mt-4">
              <div class="card-body p-4">
                <h5 class="card-title fw-semibold mb-4">booking lists</h5>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <tr>  
                          ...
                          <td class="border-bottom-0">
                            <p class="fw-semibold mb-0 fs-4">{{$items->age}}</p>
                          </td>
                          <td class="border-bottom-0">
                            <p class="fw-semibold mb-0 fs-4">{{$items->address}}</p>
                          </td>
                          <td class="border-bottom-0">
                            <p class="fw-semibold mb-0 fs-4">{{$items->gender}}</p>
                          </td> 
                          <td class="border-bottom-0">
                            ...
                            <td class="border-bottom-0">
                              <p class="fw-semibold mb-0 fs-4">{{$items->status}}</p>
                            </td>
                            <td class="border-bottom-0">
                              @if ($items->status != "Approved")
                              <a href="{{route('patient.approve',$items->id)}}" class="btn">Approve</a>
                              @endif
                            </td>
                            <td class="border-bottom-0">
                              @if ($items->status != "Approved")
                              <a href="{{route('patient.Decline',$items->id)}}"  onclick="return confirmDelete(event, this);" class="btn">Reject</a>
                              @endif
                            </td>
                            {{-- @endif --}}
                            @endforeach
