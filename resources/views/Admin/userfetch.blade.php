...
<head>
  ...
  <title>COVID-19-User_Details</title>
          ...
          <div class="col-lg-8 d-flex align-items-stretch" id="abc">
            <div class="card w-100 mt-4">
              <div class="card-body p-4">
                <h5 class="card-title fw-semibold mb-4">User lists</h5>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <tr>  
                          ...
                          <td class="border-bottom-0">
                            <p class="fw-semibold mb-0 fs-4">{{$items->email}}</p>
                          </td>
                          <td class="border-bottom-0">
                            <p class="fw-semibold mb-0 fs-4">{{$items->roles->pluck('name')->implode(',')}}</p>
                          </td>
                          <td class="border-bottom-0">
                          ...
                          <td class="border-bottom-0">
                            ...
                            <a href="{{route('users.Approve',$items->id)}}" class="btn">Approve</a>
                            @endif
                          </td>
                          <td class="border-bottom-0">
                            @if ($items->status != 'Approved' )
                            <a href="{{route('users.Reject',$items->id)}}" class="btn">Reject</a>
                          @endif
                          </td>
                          @can('edit users')
                          <td class="border-bottom-0">
                            <a href="{{route('users.edit',$items->id)}}" class="btn">Update</a>
                          </td>
                          @endcan
                            @endforeach
                          </tr>                    
